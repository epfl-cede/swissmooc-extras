...
--
-- Host: localhost    Database: docker_id_edxapp
-- ------------------------------------------------------
-- Server version	10.0.38-MariaDB-1~xenial-wsrep
...
) ENGINE=InnoDB AUTO_INCREMENT=5081 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-06-02 10:02:06
